...
const LawyerForm = ({ showModal, handleModalToggle }) => {
    ...
    const uploadFileToCloudinary = async (file, folder) => {
        ...
        formData.append('upload_preset', 'my files'); // Replace with your Cloudinary preset
    ...
    const handleFileUploadSubmit = async (e) => {
        ...
        if (validateFiles()) {
            try {
                ...
                // After successful uploads, set the file URLs
                setFormData({
                    ...formData,
                    image: imageUrl,
                ...
                setFilesUploaded(true); // Files are uploaded, show the rest of the form
            } catch (err) {
    ...
    const handleFormSubmit = async (e) => {
        ...
        // Append file URLs only if they exist
        if (formData.image) {
        ...
        try {
            const response = await axios.post(
                'http://localhost:3000/api/v1/lawyers-directory/become-a-lawyer',
                data,
                {
                    headers: {
