...
# List of Python files in the 'Python' folder to be executed
python_files = [
    'translate_to_english_query.py',
...
def run_python_files():
    ...
    for python_file in python_files:
        ...
        if os.path.exists(file_path):
            ...
            if python_file == 'pdf_chat_rag.py':
                ...
                process = subprocess.Popen(['uvicorn', 'pdf_chat_rag:app', '--reload'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
            else:
    ...
    for process in processes:
        stdout, stderr = process.communicate()  # Wait for the process to finish and get its output/error
